...
```
    ...
    VasprunData(
        ...
        poscar = Data(
            ...
            text_plain = C2  # Generated by Pivotpy
          2.46803100000000    
...
```
    ...
    [32;1m                                                   e[0m
    [32;1m ------    -----      -----     ------      --  -- --[0m
    66     3.28       0.37       0.00   20924   1 A…
    70     6.78      27.11       0.30   23752   1 A…
    6     1.39       5.28       0.00    8396   0 A…
    19     6.48      17.27       0.00    7180   0 A…
    24    24.09      45.14      24.34   13424   1 A…
