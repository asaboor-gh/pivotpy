...
__all__ = ['Dict2Data', 'Dic2Dot', 'read_asxml', 'exclude_kpts', 'get_ispin', 'get_summary', 'get_kpts', 'get_tdos',
           'get_evals', 'get_bands_pro_set', 'get_dos_pro_set', 'get_structure', 'export_vasprun', 'load_export',
           'make_dot_dict', 'dump_dict']
...
class Dict2Data(dict):
    ...
    def __repr__(self):
        items= []
        for k,v in self.__dict__.items():
            if type(v) not in (str,float,int) and not isinstance(v,Dict2Data):
