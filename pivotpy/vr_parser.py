...
__all__ = ['Dict2Data', 'read_asxml', 'exclude_kpts', 'get_ispin', 'get_summary', 'get_kpts', 'get_tdos', 'get_evals',
           'get_bands_pro_set_beta', 'get_bands_pro_set', 'get_dos_pro_set', 'get_structure', 'export_vasprun',
           'load_export', 'dump_dict', 'load_from_dump']
...
# Cell
def get_bands_pro_set_beta(xml_data=None,spin_set=1,skipk=0,bands_range=None):
    """
