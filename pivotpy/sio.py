...
__all__ = ['Arrow3D', 'fancy_quiver3d', 'save_mp_API', 'get_crystal', 'get_poscar', 'get_kpath', 'read_ticks',
           'str2kpath', 'export_poscar', 'get_kmesh', 'order', 'get_bz', 'splot_bz', 'iplot_bz', 'to_R3', 'kpoints2bz',
           'BZ', 'fix_sites', 'get_pairs', 'iplot_lat', 'splot_lat', 'join_poscars', 'write_poscar', 'scale_poscar']
...
def get_crystal(formula,api_key=None,mp_id=None,max_sites = None, min_sites=None):
    ...
    - **Parameters**
        ...
        - min_sites : Minimum number of sites. If None, sets `max_sites + 1`, if `max_sites = None`, gets all data.
    """
    all_res = _load_mp_data(formula=formula,api_key = api_key, mp_id = mp_id, max_sites = max_sites, min_sites=min_sites)
    cifs = []
    for res in all_res:
        cif     = res['cif']
