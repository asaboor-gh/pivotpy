...
# Cell
def splot_bz(poscar_or_bz = None, ax = None, plane=None,color='blue',fill=True,vectors=True,v3=False,vname='b',color_map='plasma',viewpoint=(1,-1,1),alpha=0.4):
    """
    ...
    - **Parameters**
        ...
        - viewpoint: Point from where light is thrown on BZ planes, default is (1,-1,1).
    ...
    if plane and plane not in valid_planes:
        ...
        if fill:
            ...
            if viewpoint:
                intensity = bz.normals.dot(viewpoint)
...
class BZ:
    ...
    def splot(self,ax=None, plane=None, color=(0.4,0.8,0.85), fill=True, vectors=True, v3=False,color_map='plasma',viewpoint=(1,-1,1),alpha=0.4):
        """Returns Matplotlib's Axes of BZ plot."""
        return splot_bz(self.bz,ax=ax,plane=plane,color=color,fill=fill,vectors=vectors,v3=v3,color_map=color_map,viewpoint=viewpoint,alpha=alpha)
    ...
    def splotc(self,ax=None, plane=None, color=(0.4,0.8,0.85), fill=True, vectors=True, v3=False,color_map='plasma',viewpoint=(1,-1,1),alpha=0.4):
        """Returns Matplotlib's Axes of Cell plot."""
        return splot_bz(self.cell,ax=ax,plane=plane,color=color,fill=fill,vectors=vectors,v3=v3,vname='a',color_map=color_map,viewpoint=viewpoint,alpha=alpha)
