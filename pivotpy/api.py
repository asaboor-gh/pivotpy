...
__all__ = ['download_structure', '__all__', 'parse_text', 'POSCAR', 'LOCPOT', 'CHG', 'CHGCAR', 'PARCHG', 'get_axes',
           'Vasprun']
...
class CHGCAR(LOCPOT):
    __doc__ = LOCPOT.__doc__.replace('LOCPOT','CHGCAR')
    def __init__(self, path = None,e = True,m = False):
        super().__init__(path or 'CHGCAR',e,m)
