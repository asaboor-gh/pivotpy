...
# Cell
def init_slides(number_of_slides):
    ...
    create_new_cell('This is empty cell to replace input cell. Very important')
    end_cell = f"""
                        # Only this cell should show output
                        # ------ Slides End Here --------
    ...
    create_new_cell(textwrap.dedent(end_cell))
    create_new_cell(textwrap.dedent("""
    ...
    for i in range(1,number_of_slides):
        ...
        create_new_cell(f'%%capture __slide_{sn}\n# ---- Slide {sn} ----\ndisplay(Markdown("# Slide {sn} Title"))')
