...
__all__ = ['css_style', 'dark_colors', 'light_colors', 'simple_colors', 'get_files_gui', 'InputGui', 'generate_summary',
           'VasprunApp', 'KPathApp', 'LiveSlides']
...
class LiveSlides:
    def __init__(self,func=None, iterable=None,title_page_md='# <center style="color:red"> Title',height=580):
        ...
        self.btn_prev =  Button(description='◀',layout= Layout(width='50px',height='auto')).add_class('menu')
        self.btn_next =  Button(description='▶',layout= Layout(width='50px',height='auto')).add_class('menu')
